...
var _configDist = require('../config.dist.json');

var _configDist2 = _interopRequireDefault(_configDist);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var debug = (0, _debug2.default)('trello-dispatch');
debug("config", _configDist2.default);

var labelsMapping = _configDist2.default.labels_mapping;
var t = new _nodeTrello2.default(_configDist2.default.api_key, _configDist2.default.api_token);
...
var moveCard = function moveCard(card) {
	if (card.idList === _configDist2.default.done_list_id) return;
...
var listCards = function listCards() {
	return new Promise(function (resolve, reject) {
		t.get('/1/boards/' + _configDist2.default.origin_board_id + '/cards', function (err, data) {
